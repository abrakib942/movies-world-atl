...
const signUp = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const hashPassword = yield bcrypt_1.default.hash(user === null || user === void 0 ? void 0 : user.password, Number(config_1.default.bycrypt_salt_rounds));
...
const loginUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!isExist.password) {
            throw new ApiError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, 'Password is missing');
        }
        const decriptedPassword = yield bcrypt_1.default.compare(password, isExist.password);
        if ((isExist === null || isExist === void 0 ? void 0 : isExist.password) && !decriptedPassword) {
